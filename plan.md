...
| **bf16 2048×2048×2048 (large)** | 22.86        | 65.46           | 24.79                  | 25.07                | **2.640**  | 0.922      | 0.349      | 0.912           | 14.87          | 65.0%     | 60.0%         | **compute-bound; mild regression vs cycle-36 within autotune-noise** (cycle-36 1.017 → 0.922; cycle-37 spot-check also showed 0.88-0.92 on clean-state pod — this is the same regime, not a new regression; G7-launch-fusion verification target) |
| **bf16 4096×4096×4096 (large)** | 157.50       | 486.01          | 157.15                 | 157.20               | **3.093**  | **1.002** ✅ | 0.324      | 1.002           | 119.00         | 75.6%     | 75.7%         | **compute-bound-near-peak; HOLDS** (cycle-36 1.007 → cycle-38 1.002; Helion ≈ JAX at sustained MXU ceiling) |
...
1024`` to the 2048³ / 4096³ large rows (deferred until
``G7-autotune-device``'s device-us re-rank stabilises the per-shape
autotuner picks, which cycle 38 enables).
