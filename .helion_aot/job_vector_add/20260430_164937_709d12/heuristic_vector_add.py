...
def autotune_vector_add(*args) -> dict:
    ...
    _C = [
        {'block_sizes': [2048], 'range_unroll_factors': [0], 'range_warp_specializes': [None], 'range_num_stages': [0], 'range_multi_buffers': [None], 'range_flattens': [None], 'load_eviction_policies': ['', 'first'], 'num_warps': 16, 'num_stages': 2, 'indexing': ['pointer', 'tensor_descriptor', 'pointer'], 'pid_type': 'flat'},
    ]
